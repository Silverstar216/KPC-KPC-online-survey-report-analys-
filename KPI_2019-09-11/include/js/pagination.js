Paging = function (total_count,  pageSize, cur_page) {
    ...
    html+='<label style="margin-right: 10px;"> 페이지당 :</label>';
    html+='<select id="page_per_count" style="padding: 5px 10px;" onchange="change_page_per_count()">';
    for (var i = 10; i <= 50; i=i+10) {
        page_selected = '';
        if (i == pageSize)
            page_selected = 'selected';
        html+='<option '+page_selected+' value="'+i+'">'+i+'개</option>';
