...
function onToReviewListClick($parent) {
    location.href = site_url + 'd_reviewlog/index?' + $parent ;
}
...
function onExcelClick() {
    ...
    // else
        location.href = site_url + 'd_reviewlogdetail/download_excel?kind=0';  //설문통계이면
}
function onResend(){
