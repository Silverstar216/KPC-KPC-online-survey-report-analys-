...
<body >
	...
	<form id="chkdocform" name="chkdocform" action="./chk_list.php" onsubmit="return chk_doc_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
    		...
    		<div class="chkdocform_input">		
	     		<label for="mnumber">정보 보호를 위해 수신번호 뒤4자리를 입력하세요!!<strong class="sound_only">필수</strong></label>
                        	<input type="password" name="mnumber" id="mnumber" class="frm_input required" minlength="4" maxlength="4">
