...
if ($w == '' || $w == 'r') {
    ...
    $wr_id = mysqli_insert_id($g5['connect_db']);
...
//    }
    ...
    $return_url = Main_DOMAIN.'index/board?bo_table='.$bo_table.'&amp;wr_id='.$wr_id;
    ...
    if ($is_admin == 'super') // 최고관리자 통과
        ...
        if ($write['mb_id'])
            alert('로그인 후 수정하세요.', Main_DOMAIN.'join/login_view');
    }
...
if ($file_upload_msg)
    ...
    goto_url(Main_DOMAIN.'index/board?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.$qstr);
?>
