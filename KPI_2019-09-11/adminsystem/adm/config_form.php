...
if (!$config['cf_icode_server_ip'])   $config['cf_icode_server_ip'] = '127.0.0.1';
if (!$config['cf_icode_server_port']) $config['cf_icode_server_port'] = '3306';
...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="cf_admin_email_name">관리자 발신 전화번호<strong class="sound_only">필수</strong></label></th>
            <td colspan="3">
                <?php echo help('발신전화번호인증과 설문샘풏과 전화번호인증에 보내는 발신번호를 입력합니다. (회원가입, 샘풀설문전송, 발신요청 등에서 사용)') ?>
                <input type="text" name="cf_admin_mobile" value="<?php echo $config['cf_admin_mobile'] ?>" id="cf_admin_mobile" required class="required frm_input" size="40">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="cf_login_minutes" value="<?php echo $config['cf_login_minutes'] ?>" id="cf_login_minutes" class="frm_input" size="5"> 분
            </td>
            <th scope="row"><label for="cf_new_rows">최근게시물 라인수</label></th>
            <td>
                <?php echo help('목록 한페이지당 라인수') ?>
                <input type="text" name="cf_new_rows" value="<?php echo $config['cf_new_rows'] ?>" id="cf_new_rows" class="frm_input" size="5"> 라인
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="cf_page_rows" value="<?php echo $config['cf_page_rows'] ?>" id="cf_page_rows" class="frm_input" size="5"> 라인
            </td>
            <th scope="row"><label for="cf_mobile_page_rows">모바일 한페이지당 라인수</label></th>
            <td>
                <?php echo help('모바일 목록 한페이지당 라인수') ?>
                <input type="text" name="cf_mobile_page_rows" value="<?php echo $config['cf_mobile_page_rows'] ?>" id="cf_mobile_page_rows" class="frm_input" size="5"> 라인
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="cf_write_pages">페이지 표시 수<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="cf_write_pages" value="<?php echo $config['cf_write_pages'] ?>" id="cf_write_pages" required class="required numeric frm_input" size="5"> 페이지씩 표시</td>
            <th scope="row"><label for="cf_mobile_pages">모바일 페이지 표시 수<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="cf_mobile_pages" value="<?php echo $config['cf_mobile_pages'] ?>" id="cf_mobile_pages" required class="required numeric frm_input" size="5"> 페이지씩 표시</td>
        </tr>
        <!--<tr>
...
<!--<section id="anc_cf_smsserver">
    <h2 class="h2_frm">SMS 메세지발송 데이터베이스서버 설정</h2>
    <?php /*echo $pg_anchor */?>

    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>SMS 데이터베이스서버 설정</caption>
        <colgroup>
            <col class="grid_4">
            <col>
            <col class="grid_4">
        ...
        <tbody>
        <tr>
            <th scope="row"><label for="cf_icode_server_ip">서버주소<strong class="sound_only">필수</strong></label></th>
            <td colspan="3"><input type="text" name="cf_icode_server_ip" value="<?php /*echo $config['cf_icode_server_ip'] */?>" id="cf_icode_server_ip" required class="required frm_input" size="40"></td>
        </tr>
        <tr>
            <th scope="row"><label for="cf_icode_server_port">서버포트<strong class="sound_only">필수</strong></label></th>
            <td colspan="3"><input type="text" name="cf_icode_server_port" value="<?php /*echo $config['cf_icode_server_port'] */?>" id="cf_icode_server_port" required class="required frm_input" size="40"></td>
        </tr>
        <tr>
            <th scope="row"><label for="cf_icode_id">유저식별자<strong class="sound_only">필수</strong></label></th>
            <td colspan="3">                
                <input type="text" name="cf_icode_id" value="<?php /*echo $config['cf_icode_id'] */?>" id="cf_icode_id" required class="required frm_input" size="40">
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="cf_icode_pw">유저암호<strong class="sound_only">필수</strong></label></th>
            <td colspan="3">                
                <input type="password" name="cf_icode_pw" value="<?php /*echo $config['cf_icode_pw'] */?>" id="cf_icode_pw" class="frm_input" size="40">
            </td>
        </tr>
        </tbody>
        </table>
...
/*                $arr = get_skin_dir('member', G5_MOBILE_PATH.'/'.G5_SKIN_DIR);
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="cf_leave_day" value="<?php echo $config['cf_leave_day'] ?>" id="cf_leave_day" class="frm_input" size="5"> 일 후 자동 삭제</td>
        </tr>
       <!-- <tr>
        ...
        <tr>
            <th scope="row"><label for="cf_prohibit_id">아이디,기관명 금지단어</label></th>
            <td>
                <?php echo help('회원아이디, 기관명으로 사용할 수 없는 단어를 정합니다. 쉼표 (,) 로 구분') ?>
