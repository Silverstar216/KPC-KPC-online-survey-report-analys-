...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <?php if ($w == 'u') { ?>
            <a href="<?php echo Main_DOMAIN; ?>index/faq?fm_id=<?php echo $fm_id; ?>" class="btn_frmline">보기</a>
    ...
    <tr>
        ...
        <td>
            <?php echo editor_html('fm_head_html', $fm['fm_head_html'],true,$config['cf_editor']); ?>
        </td>
    </tr>
    <tr>
        <th scope="row">하단 내용</th>
        <td>
            <?php echo editor_html('fm_tail_html', $fm['fm_tail_html'],true,$config['cf_editor']); ?>
        </td>
    </tr>
    <tr>
        <th scope="row">모바일상단 내용</th>
        <td>
            <?php echo editor_html('fm_mobile_head_html', $fm['fm_mobile_head_html'],true,$config['cf_editor']); ?>
        </td>
    </tr>
    <tr>
        <th scope="row">모바일하단 내용</th>
        <td>
            <?php echo editor_html('fm_mobile_tail_html', $fm['fm_mobile_tail_html'],true,$config['cf_editor']); ?>
        </td>
    </tr>
    </tbody>
    </table>
