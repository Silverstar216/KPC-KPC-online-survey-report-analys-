...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <?php if ($w == 'u') { ?><a href="<?php echo Main_DOMAIN; ?>index/faq?fm_id=<?php echo $fm_id; ?>" class="btn_frmline">미리보기</a><?php } ?>
        </td>
    </tr>
    <tr>
        <th scope="row">질문</th>
        <td><?php echo editor_html('fa_subject', $fa['fa_subject'],true,$config['cf_editor']); ?></td>
    </tr>
    <tr>
        <th scope="row">답변</th>
        <td><?php echo editor_html('fa_content', $fa['fa_content'],true,$config['cf_editor']); ?></td>
    </tr>
    </tbody>
    </table>
</div>
