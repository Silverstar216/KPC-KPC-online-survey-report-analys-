...
$sql_search = " where (1) and is_public <> 1 ";
if ($stx) {
    $sql_search .= " and ( ";
...
<div class="local_ov01 local_ov">
    <?php echo $listall ?>
    총설문목록 <?php echo number_format($total_count) ?>개
</div>
...
<select name="sfl" id="sfl">
    ...
    <option value="created_at"<?php echo get_selected($_GET['sfl'], "created_at"); ?>>등록일시</option>
...
<div class="tbl_head02 tbl_wrap">
    ...
    ?>
        <tr class="<?php echo $bg; ?>">
            ...
            <td style="text-align: center;" headers="mb_list_name" class="td_mbname"><?php echo $row['title']; ?></td>
