...
if (defined('G5_IS_ADMIN')) {
    ...
    echo '<link rel="stylesheet" href="'.G5_ADMIN_URL.'/css/bootstrap.css">'.PHP_EOL;
} else {
    $shop_css = '';
...
<script src="<?php echo G5_ADMIN_URL ?>/css/bootstrap.min.js"></script>;
...
<?php
if (defined('G5_IS_SERVICE')) {
?>    
    <!-- <script src="<?php echo G5_JS_URL ?>/sms_form.js"></script> -->
<?php    
}  
if(G5_IS_MOBILE) {
...
$('.list01').mouseover(function() {
          $(".list01 .nav_depth").css("display","block")
          $(".list03 .nav_depth").css("display","none")
          $(".list04 .nav_depth").css("display","none")
            
});
$('.list01 .nav_depth').mouseout(function() {
          $(".list01 .nav_depth").css("display","none") 
          $(".list03 .nav_depth").css("display","none")
          $(".list04 .nav_depth").css("display","none")
});
...
$('.list03').mouseover(function() {
          $(".list03 .nav_depth").css("display","block")
          $(".list01 .nav_depth").css("display","none")
          $(".list04 .nav_depth").css("display","none") 
          
          
});
$('.list03 .nav_depth').mouseout(function() {
          $(".list03 .nav_depth").css("display","none") 
          $(".list01 .nav_depth").css("display","none")
          $(".list04 .nav_depth").css("display","none")
});

$('.list04').mouseover(function() {
          $(".list04 .nav_depth").css("display","block")
          $(".list01 .nav_depth").css("display","none")
          $(".list03 .nav_depth").css("display","none") 
});
$('.list04 .nav_depth').mouseout(function() {
          $(".list04 .nav_depth").css("display","none") 
          $(".list03 .nav_depth").css("display","none") 
          $(".list01 .nav_depth").css("display","none")
});
