                ...
                <div class="content listWrap" style = "float:right; width: 100%;">
                    <div class="contentwrap">
                        ...
                        <div class="m7con">
                            ...
                            <input type="hidden" id='prev_survey_id' value="<?php echo $prev_survey_id?>" >
                            <div class="search">
                            ...
                            <div class="search search-items" style="text-align: center;">
                                ...
                                <ul>
                                    ...
                                    <li style="width: 22%">고객사명
                                    <input type="text" id="diagnosis_customer"></li>                                    
                                    <li style="width: 22%">과정과정명
                                    <input type="text" id="diagnosis_education"></li>
                                    <li style="width: 25%">교육과정차수
                                        <input type="text" id="diagnosis_count" style="float:right">                                        
                                    </li>
                                </ul>
                            </div>
